...
isCorrectFlavor = flavor === "vanilla" || flavor === "chocolate"
isCorrectVessel = vessel === "cone" || vessel === "bowl"
isCorrectToppings = toppings === "sprinkles" || toppings === "peanuts"

if (isCorrectFlavor && isCorrectVessel && isCorrectToppings) {
